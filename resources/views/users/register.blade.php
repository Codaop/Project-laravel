...
<body class="bg-[url(/img_bg/bg-1.jpg)] bg-cover">
    <div class="flex flex-col justify-center items-center min-h-screen">
        <div class="backdrop-blur-lg bg-white/10 border border-white/20 p-5 rounded-lg shadow-lg">
            <h1 class="text-2xl font-bold p-4 drop-shadow-md text-blue-200 text-center">Register Akun</h1>
            @if ($errors->any())
            ...
            <form action="{{ route('registerAcc') }}" method="POST">
                ...
                <table>
                    <tr>
                        <td><label for="name" class="text-white drop-shadow-md mr-1">Username</label><label for="name" class="text-red-500 mr-4">*</label></td>
                        <td><input type="text" id="name" name="name"
                                class="rounded-lg text-sm backdrop-blur-sm bg-white/15 text-white placeholder-gray-400" placeholder="Ex. syauqy2404" autocomplete="off">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="email" id="email" name="email"
                                class="rounded-lg text-sm backdrop-blur-sm bg-white/15 text-white placeholder-gray-400" placeholder="Ex. syauqy@gmail.com" autocomplete="off">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="flex items-center">
                            ...
                            <div class="relative flex items-center rounded-lg backdrop-blur-sm bg-white/15">
                                ...
                                <input type="password" id="password" name="password"
                                    class="w-full bg-transparent text-sm text-white placeholder-white/50 rounded-lg" autocomplete="off">
                ...
                <div class="mt-4 text-center">
                    <p class="text-sm text-gray-300">
                        ...
                        <a href="{{ url('/login') }}" class="font-bold text-fuchsia-200 hover:underline">
                            Sign In Now!
                        </a>
                    </p>
                </div>

...
<body class="bg-[url(/img_bg/bg-1.jpg)] bg-cover">
    <div class="flex flex-col justify-center items-center min-h-screen">
        <div class="backdrop-blur-lg bg-white/10 border border-white/20 p-5 rounded-lg shadow-lg">
            <h1 class="text-2xl font-bold p-4 drop-shadow-md text-blue-200 text-center">Halaman Tambah Jabatan</h1>
            @if ($errors->any())
            ...
            <form action="{{ route('positions.store') }}" method="POST">
                ...
                <table>
                    <tr>
                        <td><label for="nama_jabatan" class="text-white p-5">Nama Jabatan</label></td>
                        <td><input type="text" id="nama_jabatan" name="nama_jabatan" class="rounded-lg text-sm backdrop-blur-sm bg-white/15 border border-white/20 text-white"></td>
                    </tr>
                    <tr>
                        <td><label for="gaji_pokok" class="text-white p-5">Gaji Pokok Jabatan</label></td>
                        <td><input type="text" id="gaji_pokok" name="gaji_pokok" class="rounded-lg text-sm backdrop-blur-sm bg-white/15 border border-white/20 text-white"></td>
                    </tr>
                </table>
